...
for n in range(0,segments):
    file1.write("    (  {}  {}  {})\n".format(e+n*P,0,-1*Dh/2))
    file1.write("    (  {}  {}  {})\n".format(P+n*P,0,-1*Dh/2))
    file1.write("    (  {}  {}  {})\n".format(P+n*P,e,-1*Dh/2))
    file1.write("    (  {}  {}  {})\n".format(P+n*P,Dh,-1*Dh/2))
    file1.write("    (  {}  {}  {})\n".format(e+n*P,Dh,-1*Dh/2))
    file1.write("    (  {}  {}  {})\n".format(0+n*P,Dh,-1*Dh/2))
    file1.write("    (  {}  {}  {})\n".format(0+n*P,e,-1*Dh/2))
    file1.write("    (  {}  {}  {})\n\n".format(e+n*P,e,-1*Dh/2))
    
    file1.write("    (  {}  {}  {})\n".format(e+n*P,0,Dh/2))
    file1.write("    (  {}  {}  {})\n".format(P+n*P,0,Dh/2))
    file1.write("    (  {}  {}  {})\n".format(P+n*P,e,Dh/2))
    file1.write("    (  {}  {}  {})\n".format(P+n*P,Dh,Dh/2))
    file1.write("    (  {}  {}  {})\n".format(e+n*P,Dh,Dh/2))
    file1.write("    (  {}  {}  {})\n".format(0+n*P,Dh,Dh/2))
    file1.write("    (  {}  {}  {})\n".format(0+n*P,e,Dh/2))
    file1.write("    (  {}  {}  {})\n\n".format(e+n*P,e,Dh/2))

# Outlet segment
file1.write("    (  {}  {}  {})\n".format(0+segments*P,0,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(outlet+segments*P,0,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(outlet+segments*P,e,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(outlet+segments*P,Dh,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(0+segments*P,Dh,-1*Dh/2))
file1.write("    (  {}  {}  {})\n\n".format(0+segments*P,e,-1*Dh/2))

file1.write("    (  {}  {}  {})\n".format(0+segments*P,0,Dh/2))
file1.write("    (  {}  {}  {})\n".format(outlet+segments*P,0,Dh/2))
file1.write("    (  {}  {}  {})\n".format(outlet+segments*P,e,Dh/2))
file1.write("    (  {}  {}  {})\n".format(outlet+segments*P,Dh,Dh/2))
file1.write("    (  {}  {}  {})\n".format(0+segments*P,Dh,Dh/2))
file1.write("    (  {}  {}  {})\n\n".format(0+segments*P,e,Dh/2))

# Inlet segment
file1.write("    (  {}  {}  {})\n".format(-1*inlet,0,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(0,0,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(0,e,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(0,Dh,-1*Dh/2))
file1.write("    (  {}  {}  {})\n".format(-1*inlet,Dh,-1*Dh/2))
file1.write("    (  {}  {}  {})\n\n".format(-1*inlet,e,-1*Dh/2))

file1.write("    (  {}  {}  {})\n".format(-1*inlet,0,Dh/2))
file1.write("    (  {}  {}  {})\n".format(0,0,Dh/2))
file1.write("    (  {}  {}  {})\n".format(0,e,Dh/2))
file1.write("    (  {}  {}  {})\n".format(0,Dh,Dh/2))
file1.write("    (  {}  {}  {})\n".format(-1*inlet,Dh,Dh/2))
file1.write("    (  {}  {}  {})\n\n".format(-1*inlet,e,Dh/2))
